...
class MemesControllerTest < ActionController::TestCase
  ...
  test "should create meme" do
    assert_difference('Meme.count') do
      post :create, meme: { keywords: @meme.keywords, rating: @meme.rating, title: @meme.title, url: @meme.url }
    end
  ...
  test "should update meme" do
    patch :update, id: @meme, meme: { keywords: @meme.keywords, rating: @meme.rating, title: @meme.title, url: @meme.url }
    assert_redirected_to meme_path(assigns(:meme))
  end
